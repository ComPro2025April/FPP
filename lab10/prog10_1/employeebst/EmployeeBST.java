...
import lab10.prog10_1.employeebst.Employee;
import lab10.prog10_1.employeebst.NameComparator;

import java.util.ArrayList;
import java.util.Collections;
import java.util.List;

public class EmployeeBST extends NameComparator {
    /** The tree root. */
    private Node root;
    ...
    private void printPreTree(Node t) {
        if (t != null) {
            System.out.println(t.element);
            printPreTree(t.left);
    ...
    private void printPostTree(Node t) {
        if (t != null) {
